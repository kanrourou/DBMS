...
class Filter : public Iterator {
    ...
    private:
    	...
    	RC freeMemory(void* page_dummy); // free memory allocated by malloc()
...
class Project : public Iterator {
    ...
    private:
        ...
        RC freeMemory(void* page_dummy); // free memory allocated by malloc()
        void mapAttrInfo(void* data, vector<unsigned> &offsets, vector<unsigned> &lengths);
};
...
class Aggregate : public Iterator {
    ...
    private:
        ...
        void getMIN(void* res);
        void getMAX(void* res);
        void getSUM(void* res);
        void getAVG(void* res);
        void getCOUNT(void* res);
        int getInt(void* data);
        float getReal(void* data);
        unsigned getOffset(void* data);
